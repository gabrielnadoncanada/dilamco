    ...
    return (
        <div className='sticky top-16'>
            ...
            <div className='mt-17.5'>
                ...
                <InputFiled placeholder={"Type & Hit Enter"} type={'text'} />
            </div>
            <div className='mt-17.5'>
                <form action="">
                    <Title title_text={"Schedule a Call"} />
                    <InputFiled placeholder={"Your Name"} type={'text'} className="mb-[15px]" />
                    <InputFiled placeholder={"Phone Number"} type={'number'} className="mb-[15px]" />
                    <InputFiled placeholder={"Phone Number"} type={'date'} className="mb-[15px]" />
