            ...
            <section>
                ...
                <div className='container lg:pt-30 2sm:pt-20 pt-14'>
                    <div className='grid lg:grid-cols-2 gap-5'>
                        ...
                        <form>
                            <InputFiled placeholder={"Your Name"} type={"text"} className={"mb-[13px]"} />
                            <div className='flex sm:flex-row flex-col gap-x-5'>
                                <InputFiled placeholder={"Phone Number"} type={"number"} className={"mb-[13px]"} />
                                <InputFiled placeholder={"Your Email"} type={"email"} className={"mb-[13px]"} />
                            </div>
